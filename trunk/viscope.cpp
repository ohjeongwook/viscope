...
extern "C" HRESULT ExtQuery(PDEBUG_CLIENT4 Client)
{
	...
	if((Status=Client->QueryInterface(__uuidof(IDebugSymbols3),(void **)&g_ExtSymbols))!=S_OK)
	{
		goto Fail;
	}
...
extern "C" HRESULT CALLBACK KnownStructOutput(
	__in ULONG Flag,
