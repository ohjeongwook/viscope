...
int ConvertUsingDOT(char *DotFilename,char *Format="png",char *PNGFilename=NULL)
{
	...
	_snprintf(szCmdline,sizeof(szCmdline)-1,"\"C:\\Program Files\\Graphviz2.24\\bin\\dot.exe\" -T%s -o%s %s",Format,PNGFilename,DotFilename);
...
HRESULT CALLBACK help(PDEBUG_CLIENT4 Client,PCSTR args)
{
	...
	dprintf("Help for viscope.dll\n"
			...
			"  u <addr> - Show disassembly of the address\n"
